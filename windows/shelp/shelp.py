...
## python -m nuitka --standalone --onefile --disable-console --remove-output .\shelp.py
...
paths = {
    ...
    'self' : f'{home}\\working_folder\\.scripts\\windows',
    ''     : f'{home}\\working_folder\\.scripts\\windows',
}
mappings = {
    't':terminal,
    'terminal':terminal,
...
def zenity(command):
    ...
    res = str(stdout)[2:-5].strip() # slicing to get rid of quotes and new line character
    print(res)
    return res
