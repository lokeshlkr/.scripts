...
sudo cp ~/working_folder/.scripts/fonts/GoogleSansCode/* /usr/share/fonts/
sudo cp ~/working_folder/.scripts/fonts/Gabarito/* /usr/share/fonts/
...
mkdir -p ~/.themes
mkdir -p ~/.icons
cp -r ~/working_folder/.scripts/xfce/.themes/* ~/.themes
cp -r ~/working_folder/.scripts/xfce/.icons/* ~/.icons
